...
\end{theorem}
\begin{proof}
Let $\mathcal{F} = \{F \subset \P(S) \mid F \text{ is a filter on }S,\  F\supset E\}$. Then $\left(\mathcal{F}, \subset\right)$ is a poset with $E\in \mathcal{F}$. 
\begin{claim}
