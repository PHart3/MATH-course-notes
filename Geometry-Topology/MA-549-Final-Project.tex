...
\begin{abstract}
We briefly describe the isometries of $\C^2$. In particular, we classify five important groups of such maps in the category $\mathbf{Top}$ of topological spaces. 
\end{abstract}
...
\item $\Isom(\R^4)$
\end{itemize}
with \emph{topological} characterizations, having treated them only as algebraic objects thus far.
