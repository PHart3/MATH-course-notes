...
\begin{remark}{\Cref{l1} shows that it's enough to construct any smooth atlas for $M$ to show it's a smooth manifold.}
\end{remark}
...
\begin{lemma}[Smooth manifold construction lemma]\label{smc}
