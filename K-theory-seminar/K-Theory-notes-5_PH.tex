...
Moreover, the face maps $d_i$ are given by deleting the row $X_{i, -}$ and the column containing $X_i$ in $(\ast)$ of \cref{note} and then reindexing as necessary. The degeneracy maps $s_i$ are given by duplicating $X_i$ and then reindexing such that $X_{i+1, i} =0$.\reversemarginpar{\marginpar{\small{Not sure that the $s_i$ work.}}}
\end{definition}
