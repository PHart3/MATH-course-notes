...
Any property $P$ of $\c$ (expressible in our metatheory) has a dual property $P^{\op}$ of $\c^{\op}$ obtained by interchanging the source and target of any arrow as well as the order of any composition in the sentence expressing $P$. Then $P$ is true of $\c$ iff $P^{\op}$ is true of $\c^{\op}$.
...
\]
This shows that $\set$ is both complete and cocomplete.
...
\begin{enumerate}
\item For any global element $p: 1 \to Y$ of $Y$, the \textit{fiber $f^{{-1}}(p)$ of $f$}  at $p$ is the pullback  of the cospan $1 \rightarrow Y \leftarrow X$.
