...
We can perform a dual construction for $\j^{\op}$. Then the colimit of the resulting diagram is called the \textit{pushout}, denoted by $B \cup_{C} A$. The universal property of a pullback square states that for any commutative diagram of the form
\[
\begin{tikzcd}
...
\begin{corollary}
Both $\mathbf{Set}$ and $\mathbf{Grp}$ are complete and cocomplete (i.e., \textit{bicomplete}).
\end{corollary}
