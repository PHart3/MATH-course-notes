...
Let $\c^w$ denote the Waldhausen subcategory of $(\c, v)$ consisting of all $A$ such that $\ast \to A$ belongs to $w(\c)$.\reversemarginpar{\marginpar{\small{Are the initial morphisms the only weak equivalences?}}}
