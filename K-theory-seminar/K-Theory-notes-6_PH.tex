...
\end{corollary}
\begin{proof}[Proof sketch]
One can show that each functor $S_n \a \to S_n \b$ is exact and also has the approximate lifting property.  \Cref{pp} thus gives rise to degree-wise homotopy equivalence between the bisimplicial map $wS_{\bullet}\a \to wS_{\bullet} \b$, which is enough. 
\end{proof}
