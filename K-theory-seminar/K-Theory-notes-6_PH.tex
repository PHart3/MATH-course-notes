...
\medskip
 ...
 It therefore suffices to show that the top row is a fibration.\reversemarginpar{\marginpar{\small{What about the left vertical morphism?}}} You can do this by using the relative $K$-theory space construction. See Weibel, IV.8.5.3 and V.2.1.
\end{proof}
