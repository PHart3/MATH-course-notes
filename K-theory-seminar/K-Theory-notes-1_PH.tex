...
\begin{remark}
Any Grothendieck universe models $\ZFC$, in particular $\mathsf{Replacement}$. This ensures that for any two functors $F, G: \c \to \d$, the class of natural transformation $\phi: F \Rightarrow G$ is a set. This means that $\mathbf{Fun}(\c, \d)$ is locally small, a condition of our definition of a category.
\end{remark}
