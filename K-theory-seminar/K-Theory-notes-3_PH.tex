...
\begin{enumerate}
\item Any $k$-vector space where $\otimes \coloneqq \otimes_k$.
\item Any category with finite coproducts where $s \otimes t\coloneqq s \amalg t$.
\item The category of pointed topological spaces where $s \otimes t \coloneqq s \wedge t $ and $e\coloneqq S^0$.
\end{enumerate} 
\end{exmp}
