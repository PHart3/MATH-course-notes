...
\begin{align*} \v & = \u^{\perp} \underbrace{\equiv \{y \in \ob{\d} \mid \Hom_{\d}(x,y) = 0, \ x \in \ob{\u}\}}_{\text{full subcategory}}
\\ \u  & = {^{\perp}{\v}} \underbrace{\equiv \{x \in \ob{\d} \mid \Hom_{\d}(x,y) =0, \ y \in \ob{\v}\}}_{\text{full subcategory}}.
